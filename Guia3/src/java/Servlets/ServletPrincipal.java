...
public class ServletPrincipal extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String nombres = request.getParameter("tfNombre");
            ...
            out.println("<h1>INGRESAR UN PRODUCTO</h1>");
            out.println("<strong>Nombres: </strong>" + nombres);
            out.println("<br><strong>Apellidos: </strong>" + descripcion);
            out.println("<br><br><strong>Opinión: </strong>" + precio);
            out.println("<br><strong>Comentarios: </strong>" + categoria);
